...
function updateStore(feature) {
  Alpine.store("selectedStore").id = feature.id;
  Alpine.store("selectedStore").title = feature.properties.title;
  Alpine.store("selectedStore").description = feature.properties.description;
  Alpine.store("selectedStore").imageUrl = mediaUrl + feature.properties.thumbnail;
  console.log(Alpine.store("selectedStore").imageUrl);
}
